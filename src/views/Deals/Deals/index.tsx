...
import {
    MainOut, MainRightOut, MainRight, TblOut, TitlePart, Btns, Title, TiitleRight, ResBack, SearchBtn, SearchInput, SearchPart, ContactBtn, NewAppBtn, TblPart, Thead, TCheck, TheadName, TheadGrp, TRow, TNameImg, StatusItem, TRowName, TNameOut, MarkPart, MarkItem, MarkTop, MarkMiddle, MarkBottom, MarkSub, MarkTitle,
} from "./deal.style";
const DashboardContainer = () => {
    ...
    return (
        <MainOut>
            <SideBar selected={3} show={sidebarshow} />
